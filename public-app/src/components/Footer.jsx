        ...
        <div className="flex flex-col items-center text-center gap-8 mb-12">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <a 
              ...
              className="inline-flex items-center gap-2 bg-[#25D366] hover:bg-[#20bd5a] text-white px-8 py-4 rounded-xl font-bold transition-all shadow-lg hover:shadow-green-500/10 hover:scale-[1.02] transform"
            >
